...
{
	WP_TRACE("INFO: BinkVideoPlayer() - Linux stub (Windows Bink SDK not available)\n");
}

// Stub destructor
BinkVideoPlayer::~BinkVideoPlayer()
{
	WP_TRACE("INFO: ~BinkVideoPlayer() - Linux stub\n");
}

// Subsystem requirements - all stubs for Linux
void BinkVideoPlayer::init(void)
{
	WP_TRACE("WARNING: BinkVideoPlayer::init() - Linux stub (video playback not available)\n");
}

void BinkVideoPlayer::reset(void)
{
	WP_TRACE("DEBUG: BinkVideoPlayer::reset() - Linux stub\n");
}
...
{
	WP_TRACE("DEBUG: BinkVideoPlayer::deinit() - Linux stub\n");
}

// Focus management - stubs for Linux
void BinkVideoPlayer::loseFocus(void)
{
	WP_TRACE("DEBUG: BinkVideoPlayer::loseFocus() - Linux stub\n");
}

void BinkVideoPlayer::regainFocus(void)
{
	WP_TRACE("DEBUG: BinkVideoPlayer::regainFocus() - Linux stub\n");
}

// Video file operations - stubs for Linux
VideoStreamInterface* BinkVideoPlayer::open(AsciiString movieTitle)
{
	WP_TRACE("WARNING: BinkVideoPlayer::open('%s') - Linux stub (video playback not available)\n", 
...
{
	WP_TRACE("WARNING: BinkVideoPlayer::load('%s') - Linux stub (video playback not available)\n", 
		movieTitle.str() ? movieTitle.str() : "(null)");
...
{
	WP_TRACE("DEBUG: BinkVideoPlayer::notifyVideoPlayerOfNewProvider(%d) - Linux stub\n", nowHasValid);
}
